...
const TermsAndConditions: React.FC = () => {
    return (
        <div>
            <PageTemplate titlePage="TERMOS E CONDIÇÕES" mainModel="red-main">
                ...
                <div className="content-text">
                    ...
                    <p className="justify-text">
                        ...
                        acesso individuais do conteúdo. Para os propósitos desta
                        licença de usuário, conteúdo significa qualquer material
                        (em qualquer formato) que o site disponibilize para você
                        acessar e imprimir ou baixar no ou através do site
                        AllanKardec.online. Ao copiar ou usar qualquer conteúdo,
                    ...
                    <p className="justify-text">
                        ...
                        deve (sempre que possível) reconhecer a fonte do
                        conteúdo da seguinte forma: “Descrição do documento
                        utilizado conforme o Título dado ao documento no site
                        AllanKardec.online”, Crédito da Foto: AllanKardec.online
                    ...
                    <p className="justify-text">
                        ...
                        comerciais significa qualquer uso do conteúdo que é
                        primariamente destinado ou direcionado para vantagem
                        comercial ou compensação monetária. Isto inclui qualquer
                        uso em ou em qualquer coisa que seja cobrado, está
                    ...
                    <p className="justify-text">
                        ...
                        <span className="email">allankardec.online@gmail.com</span>
                    </p>
                    ...
                    <p className="justify-text">
                        ...
                        access. For the purposes of this user licence, content
                        means any material (in any format) that the
                        AllanKardec.online makes available to you to access and
                        print or download on or through the AllanKardec.online
                        website from time to time. By copying or using any
                    ...
                    <p className="justify-text">
                        ...
                        must (wherever possible) acknowledge the source of the
                        content in the following form: “Description of the
                        document used according to the title given to the
                        document on the AllanKardec.online website”, Photo:
                    ...
                    <p className="justify-text">
                        ...
                        publicity and privacy rights, or contractual
                        restrictions) as may be specified in the metadata or as
                        may otherwise apply to the Content. This licence does
                        not affect your freedom under fair dealing or any other
                    ...
                    <p className="justify-text">
                        ...
                        user licence, commercial purposes means any use of the
                        content that is primarily intended for or directed
                        toward commercial advantage or monetary compensation.
                        This includes any use on or in anything that is itself
